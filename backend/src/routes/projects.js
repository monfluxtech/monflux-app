...
router.patch('/:id/phases/:phaseId', async (req, res) => {
  const allowed = ['name','status','color','start_date','end_date','actual_start','actual_end','progress_pct','display_order','trade_name','start_time','duration_hours','assigned_to_name'];
